...
for song in songs.find({"spotify_id": {"$exists": False}}):
    ...
    try:
        ...
        outfile.write(song_artist + ", " + song_name + ": " + "Spotify track returns 404 error" + "\n")
    ...
    try:
        ...
        outfile.write(song_artist + ", " + song_name + ": " + "Spotify track_id not found" + "\n")
    ...
    try:
        ...
        outfile.write(song_artist + ", " + song_name + ": " + "Spotify audio features result not found" + "\n")
    ...
    try:
        ...
        outfile.write(song_artist + ", " + song_name + ": " + "Spotify audio features are incomplete" + "\n")
